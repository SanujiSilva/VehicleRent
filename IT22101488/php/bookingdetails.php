...
<body>
<h2 class="font2"><center> Budget Vehicle Dealers </center></h2>
 ...
 <button class="login1" style="float:right" width=100 height=100 onclick="location.href='../../IT22082374html/login.html';">Login</button>
<ul class="menu">
...
<br> 
<div class="layout">
	<button class="bttn1" type="button"  onclick="location.href='../html/Booking.html';">Booking</button>
