...
<h2 form class="font2"><center>Budget Vehicle Dealers</center></h2>
...
<body>
 ...
 <button class="login1" style="float:right" width=100 height=100 onclick="location.href='../../IT22082374/html/login.html';">Login</button>
<ul class="menu">
